    ...
    <div className="flex flex-col justify-center items-center h-full w-full">
      ...
      <div className="flex justify-center w-3/4 flex-wrap text-white">
        ...
        <div className="basis-1/4 my-4 flex justify-center items-center">
          <Link
            to="/game4/medium/"
            className="font-montserrat text-center flex justify-center items-center w-32 h-32 hover:bg-gradient-radial from-blue-500 to-blue-900 bg-blue-900 border-8 text-4xl font-bold border-blue-500 rounded-xl"
          >
            30
            <br />
            sec
        ...
        <div className="basis-1/4 my-4 flex justify-center items-center">
          <Link
            to="/game4/hard/"
            className="font-montserrat text-center flex justify-center items-center w-32 h-32 hover:bg-gradient-radial from-red-500 to-red-900 bg-red-900 border-8 text-4xl font-bold border-red-500 rounded-xl"
          >
            15
            <br />
            sec
